...
list_steps() {
  ...
  if [[ "$ENV" == "bare-metal" ]]; then
    ...
    echo "  8. nvidia         - NVIDIA GPU Drivers"
    echo "  9. virtualization - Virtualization & Nested Virtualization"
    echo "  10. vscodium      - VSCodium Extensions"
    echo "  11. fonts         - Nerd Fonts"
    echo "  12. distrobox     - Distrobox Containers"
    echo "  13. post_install  - Post-install Configuration"
  else
    echo "  1. repos          - External Repositories"
    echo "  2. scripts        - Script-based Installs"
    echo "  3. copr           - COPR Repositories"
    echo "  4. dnf            - DNF Packages"
    echo "  5. cargo          - Cargo Packages"
    echo "  6. fonts          - Nerd Fonts"
    echo "  7. post_install   - Post-install Configuration"
  fi
  echo ""
}
